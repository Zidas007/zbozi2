...
Revision ID: 4efe95675bd6
Revises: None
Create Date: 2018-10-16 11:35:02.059371

"""

# revision identifiers, used by Alembic.
revision = '4efe95675bd6'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_Zbozi_ks', 'Zbozi', ['ks'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_Zbozi_ks', table_name='Zbozi')
    op.drop_table('Zbozi')
    ### end Alembic commands ###
